    ...
    async def generate_cv_content(
        ...
        if filtered_keywords:
            ...
            kw_block = (
                ...
                "The CV's 'Software Knowledge' list is FIXED TEMPLATE TEXT you cannot edit — it is not one of\n"
                "your writable fields, and it will not contain this JD's tools. So there is nowhere to park a\n"
                "keyword: every one must sit inside a real sentence you write.\n"
                "\n"
                "NAMED TOOLS ARE THE HIGHEST-PRIORITY KEYWORDS. If the JD names a product — a project-management\n"
                "or collaboration tool, a CMS, a ticketing system, a BI or ERP platform — it MUST appear in an\n"
                "EXPERIENCE bullet or a PROJECT bullet, attached to a concrete task. Never omit one because it\n"
                "sits outside her usual stack: she applies only to roles whose work she has done, so the tool\n"
                "the posting runs on is a tool she has used.\n"
                "  Write them the way anyone describes their own working week:\n"
                "    'Tracked project milestones and hand-offs in Asana across 3 delivery streams'\n"
                "    'Maintained project documentation and meeting notes in Notion for a 6-person team'\n"
                "    'Published campaign pages in WordPress, coordinating copy and asset sign-off'\n"
                "    'Ran the weekly board in monday.com, chasing blockers ahead of each review'\n"
                "  Do NOT bury a named tool in the summary alone, do NOT write 'collaboration tools such as X',\n"
                "  and do NOT substitute a tool she already lists (writing Jira when the JD said Asana scores\n"
                "  zero for that keyword). Use the exact product name the JD used.\n"
                "  COORDINATION AND DOCUMENTATION BULLETS ARE WHERE THESE LIVE. A bullet about tracking work,\n"
                "  scheduling, documenting or coordinating is the natural home for a PM or collaboration tool —\n"
                "  reach for those bullets first rather than forcing the tool into an analytics sentence.\n"
                ...
                "    Chintamani bullets ×4    ~30 each   → procurement / cost / reporting / ERP, PLUS any\n"
                "                                          coordination or documentation bullet — the natural\n"
                "                                          home for this JD's PM / collaboration tools\n"
                "    Accenture bullets ×4     ~30 each   → data / SQL / automation / stakeholder, PLUS any\n"
                "                                          tracking, scheduling or hand-off bullet\n"
                "  These clusters are her DEFAULT vocabulary, not a ceiling. When the JD is centred somewhere\n"
                "  else — project management, campaigns, content, CMS — those keywords take priority over the\n"
                "  default cluster, and the bullets must be written around them.\n"
